<template>
    <div class="container mt-4">
      ...
      <form v-if="!isOrderSubmitted" @submit.prevent="submitOrder">
        ...
        <button type="submit" class="btn btn-primary me-2">Отправить заказ</button>
        <button type="button" class="btn btn-secondary" @click="cancelOrder">Отменить заказ</button>
      </form>
      <div v-else>
